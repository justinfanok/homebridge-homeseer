...
var typeProperties =
{
	...
	"Heater":
	{
		Properties: 
		{
			...
			"batteryThreshold": 25,
			"temperatureUnit":"F",	
			"controlRef": 0,			// Set to HomeSeer device by which you select the Off / Heat state.
			"stateRef": 0,				// Set to HomeSeer device reporting the actually running state (Off / Heat ). Sometimes this is the same as controlRef!
			"heatingSetpointRef": 0,	// Either "heatingSetpointRef" or "coolingSetpointRef" must be set (usually both are!)
		},
