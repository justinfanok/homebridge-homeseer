...
var checkConfig = function(config, allHSDevices)
{
	...
	{ 
		...
		{
			error = red("Too many accessories and events in config.json file. Bridge maximum is 100. See Wiki entry regarding Running Multiple Instances of Homebridge for fix!" );
